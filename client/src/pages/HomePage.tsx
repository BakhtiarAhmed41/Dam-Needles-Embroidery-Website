  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden bg-white">
        ...
        >
          <div className="animate-hero-float h-full w-full">
            <img
        ...
        <div className="relative z-10">
          ...
          <div className="section-container py-10 sm:py-12 lg:py-14 lg:pr-[45%]">
            <ScrollAnimation animation="fadeInLeft" className="max-w-xl">
              ...
              <div className="flex flex-wrap gap-3 sm:gap-4">
                <a href="#categories" className="btn-primary px-5 py-2.5 transition-all sm:px-6 sm:py-3">
                  Explore Categories <ArrowRightIcon className="h-4 w-4" />
                </a>
                <a
                  href="#quote"
                  className="inline-flex items-center justify-center rounded border border-brand-blue bg-white px-5 py-2.5 text-sm font-bold text-brand-blue transition-all hover:bg-brand-blue/5 sm:px-6 sm:py-3"
                >
                  Request A Quote
                </a>
              </div>
            ...
            <div className="w-full sm:w-[70%]">
              <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4 lg:gap-5">
                {features.map((f, index) => (
                  <ScrollAnimation key={f.title} delay={0.1 + index * 0.1}>
        ...
        {/* Mobile image */}
        <ScrollAnimation animation="fadeInUp" delay={0.15} className="relative h-56 sm:h-72 lg:hidden">
          <div className="animate-hero-float h-full w-full">
            <img
              src="/images/hero-split.jpg"
      ...
      <section className="py-16" id="services">
        <div className="section-container">
          <ScrollAnimation className="mb-8 flex flex-wrap items-end justify-between gap-4">
            <h2 className="section-heading">Shop By Industry</h2>
            <a
              href="#"
              className="flex items-center gap-1 text-sm font-bold tracking-wide text-brand-blue uppercase transition-colors hover:text-brand-gold"
            >
          ...
          <div className="-mx-4 flex gap-3 overflow-x-auto px-4 pb-2 carousel-scroll sm:mx-0 sm:gap-4 sm:px-0 lg:grid lg:grid-cols-6 lg:overflow-visible lg:pb-0">
            {industries.map((ind, index) => (
              ...
              >
                <a
                  href="#"
                  className="group relative block w-[42vw] max-w-[180px] overflow-hidden rounded-xl shadow-md transition-all hover:shadow-xl sm:w-[28vw] lg:w-auto lg:max-w-none"
                >
                  <img
                    src={ind.image}
                    alt={ind.name}
        ...
        <div className="section-container">
          ...
          <Carousel>
            {garments.map((g, index) => (
              <ScrollAnimation key={g.name} delay={0.05 + index * 0.03} className="shrink-0">
                <a
                  href="#"
                  className="block w-44 overflow-hidden rounded-xl bg-gray-100 transition-all hover:shadow-md sm:w-52"
                >
        ...
        <div className="section-container">
          ...
          <div className="grid gap-6 md:grid-cols-3">
            {categories.map((cat, index) => (
              <ScrollAnimation key={cat.title} delay={0.1 + index * 0.1}>
                <a
                  href="#"
        ...
        <div className="section-container">
          ...
          <Carousel>
            {portfolio.map((item, index) => (
              <ScrollAnimation key={item.image} delay={0.05 + index * 0.03} className="shrink-0">
                <div className="w-64 overflow-hidden rounded-xl shadow-md transition-shadow hover:shadow-lg sm:w-72">
            ...
            <div className="hidden items-start justify-center lg:flex">
              {steps.map((step, index) => (
                <Fragment key={step.num}>
                  <ScrollAnimation delay={0.1 + index * 0.1} className="flex w-[150px] shrink-0 flex-col items-center text-center xl:w-[165px]">
                    <div className="relative mb-3">
                      <span className="absolute -top-0.5 -left-0.5 z-20 flex h-5 w-5 items-center justify-center rounded-full bg-brand-gold text-[10px] font-bold text-gray-900">
                        {step.num}
                      </span>
        ...
        <div className="section-container">
          <div className="overflow-hidden rounded-2xl bg-brand-blue shadow-xl">
            <div className="grid items-center lg:grid-cols-2">
              <ScrollAnimation animation="fadeInLeft" className="p-8 sm:p-12">
                ...
                <a href="#contact" className="btn-primary transition-all">
                  Get In Touch <ArrowRightIcon />
                </a>
              </ScrollAnimation>
              <ScrollAnimation animation="fadeInRight" delay={0.15} className="relative h-64 lg:h-full lg:min-h-[320px]">
                <img
        ...
        <div className="section-container">
          ...
          <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-4">
            {whyChoose.map((item, index) => (
              <ScrollAnimation key={item.title} delay={0.1 + index * 0.1}>
