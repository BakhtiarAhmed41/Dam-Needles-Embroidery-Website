      ...
      <div className="section-container grid gap-10 py-12 sm:grid-cols-2 lg:grid-cols-5 lg:gap-8">
        ...
        <div className="lg:col-span-1">
          ...
          <div className="flex items-center gap-3">
            <a href="#" className="rounded-full bg-white/10 p-2 hover:bg-brand-gold" aria-label="Facebook">
              <FacebookIcon className="h-4 w-4" />
            </a>
            <a href="#" className="rounded-full bg-white/10 p-2 hover:bg-brand-gold" aria-label="Instagram">
              <InstagramIcon className="h-4 w-4" />
            </a>
            <a
              href="mailto:info@damneedlesembroidery.co.uk"
              className="rounded-full bg-white/10 p-2 hover:bg-brand-gold"
              aria-label="Email"
            >
        ...
        <div>
          ...
          <ul className="space-y-2.5 text-sm text-white/80">
            <li>
              <a href="tel:07754605739" className="hover:text-brand-gold">
                07754 605739
              </a>
            </li>
            <li>
              <a href="tel:01483276000" className="hover:text-brand-gold">
                01483 276000
              </a>
            </li>
            <li>
              <a href="mailto:info@damneedlesembroidery.co.uk" className="hover:text-brand-gold">
